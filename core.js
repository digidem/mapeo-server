...
function Core (osm, media, opts) {
  if (!(this instanceof Core)) return new Core(osm, media, opts)
  if (!opts) opts = {}
  this.sync = sync(osm, media, opts)
  this.osm = osm
  this.media = media
}

Core.prototype.observationCreate = function (obs, cb) {
  try {
...
Core.prototype.observationGet = function (id, cb) {
...
Core.prototype.observationConvert = function (id, cb) {
  var self = this
...
Core.prototype.observationUpdate = function (newObs, cb) {
  var self = this
...
Core.prototype.observationDelete = function (id, cb) {
  this.osm.del(id, cb)
}

Core.prototype.observationList = function (cb) {
  var results = []
...
Core.prototype.observationStream = function () {
